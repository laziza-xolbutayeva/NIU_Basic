        ...
        <div className="container">
          <div className="col-12 mb-5">
            <ul className="News-title d-flex">
              ...
              <li>
                <NavLink to="/UniversityAbout/University" className="News-title-now">
                  Navoiy innovatsiyalar universiteti haqida
                </NavLink>
              </li>
            </ul>
            <h3 className="News-title-h">Navoiy innovatsiyalar universiteti haqida</h3>
          </div>
