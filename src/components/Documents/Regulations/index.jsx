      ...
      <section className="index-News">
        <div className="container">
          ...
          <div className="docDownload">
            <div className="docDownload_box d-flex justify-content-between">
              <div className="d-flex">
                ...
                <p>Nizomlar va qoidalar</p>
              </div>
              <a href="#" download className="docDownload_btn">
                Yuklab olish
              </a>
            </div>
            </div>
